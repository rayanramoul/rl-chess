...
parser.add_argument('--agent', type=str, default='random', help='The agent to play against (path to pickle file)')
# choose which color the agentt plays
parser.add_argument('--agent_color', type=str, default='black', help='The color of the agent')	
